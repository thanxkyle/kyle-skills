...
Pick the case study that best matches the brand's concept type and the pain point you're referencing. Use these thanx.com URLs only. Never share Google Drive links; those are for internal use only.
...
- **Email 5 (Day 25)**: Value drop. Share something genuinely useful: a trend, insight, or observation. Zero ask. Show you're a peer, not a vendor.
...
### The Core Posture
Write as an **expert partner, not a vendor.** The posture: *I know your industry and I'm bringing you something worth knowing.* Not *please consider our product.* Every email should feel like a smart peer sharing intelligence, not a salesperson asking for time.
...
15. **Data earns the right to the opinion.** Every substantial claim needs a specific number or a named example. Not "most restaurants." Use "Pokeworks saw 4x enrollment growth in 7 months." Unsourced claims get cut.
